<template>
  <article
    ...
    @click="
      router.push({
        name: 'product',
        params: { id: campaignProduct?.product?.id ? campaignProduct?.product?.id : 12345 },
      })
    "
  >
    <div
    ...
    >
      ...
      <p
        ...
        :class="
          cart.isItemInCart(
            campaignProduct.product ? campaignProduct.product.id : defaultProduct.id,
          )
      ...
      <p class="font-normal text-black mb-5">
        {{
          campaignProduct.product
            ...
            : 'League Battle Deck -Charizard ex- PREVENTA'
        }}
      </p>
