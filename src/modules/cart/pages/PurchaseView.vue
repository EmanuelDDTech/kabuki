...
<template>
  <div class="max-w-screen-xl mx-auto my-10">
    <div class="mx-4 p-10 bg-shori-gray-2 rounded-lg">
      <p class="text-lg text-shori-gray-12">Gracias!</p>
      ...
      <ul class="border border-shori-gray-6 bg-shori-gray-3 rounded-md divide-y">
        <li
        ...
        >
          ...
          <div class="flex flex-col flex-1">
            <span class="font-semibold text-shori-gray-12 mb-3">{{ sale_cart.product.name }}</span>
      ...
      <div class="mt-8 px-4">
        ...
        <div class="text-sm text-shori-gray-11 mt-3 mb-6" v-if="saleStore.purchaseInfo?.address">
          ...
          <p>
            {{ saleStore.purchaseInfo?.address?.phone }}
          </p>
        </div>
